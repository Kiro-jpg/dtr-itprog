    ...
    if (isset($_POST["view"])) {
        ...
        while ($cell = mysqli_fetch_array($query)) {
            ...
            if (($cell["inlog"] != null) && ($cell["outlog"] != null)) {
                ...
                if ($minhour > 8) {
                    echo '<div class="row">';
                    echo '<div class="cell" data-title="Logged ID">', $cell['logid'], '</div>';
        ...
        if ($hinmour != 0) {
            ...
            echo '<div class="cell" data-title="Days Present">  </div>';
            echo '<div class="cell" data-title="Days Present"> </div>';
            echo '<div class="cell" data-title="Time In"></div>';
            echo '<div class="cell" data-title="Days Present">', $overmour, ' </div>';
            echo '</div>';

...
<form action='<?php echo $_SERVER["PHP_SELF"]; ?>' method='post'>
                                    ...
                                    if (isset($_POST["search"])) {
                                        ...
                                        echo "Start Day : <input type='text' name='sday' value='$sday1' size='30'><br/>";
                                        echo "Start Month : <input type='text' name='smonth' value='$smonth1' size='30'><br/>";
                                        echo "Start Year : <input type='text' name='syear' value='$syear1' size='30'><br/>";
                                        echo "End Day : <input type='text' name='eday' value='$eday1' size='30'><br/>";
                                        echo "End Month : <input type='text' name='emonth' value='$emonth1' size='30'><br/>";
                                        echo "End Year : <input type='text' name='eyear' value='$eyear1' size='30'><br/>";
                                        echo "Time In : <input type='text' name='timein' value='$timein' size='30'><br/>";
                                        echo "Time Out  : <input type='text' name='timeout' value='$timeout' size='30'><br/>";
                                        echo "Workdays : <input type='text' name='work' value='$work' size='30'><br/>";
...
<!--Delete---->
<form action='<?php echo $_SERVER["PHP_SELF"]; ?>' method='post'>
                                        Search Employee : <input type='text' name='logID' size='10' /><br />
